...
!(function (a) {
    ...
    ;(b = (function () {
        ...
        (b.prototype.getNavTarget = function () {
            const b = this
            let c = b.options.asNavFor
            return c && c !== null && (c = a(c).not(b.$slider)), c
        }),
        (b.prototype.asNavFor = function (b) {
            const c = this
            const d = c.getNavTarget()
            d !== null &&
                typeof d === 'object' &&
                d.each(function () {
        ...
        (b.prototype.autoPlayIterator = function () {
            const a = this
            let b = a.currentSlide + a.options.slidesToScroll
            a.paused ||
                a.interrupted ||
                a.focussed ||
        ...
        (b.prototype.buildOut = function () {
            ...
            ;(b.$slides = b.$slider
                ...
                b.updateDots(),
                b.setSlideClasses(
                    typeof b.currentSlide === 'number' ? b.currentSlide : 0
                ),
                ...
                for (
                    ...
                    for (c = 0; c < a.options.rows; c++) {
                        ...
                        for (d = 0; d < a.options.slidesPerRow; d++) {
                            const k = b * h + (c * a.options.slidesPerRow + d)
        ...
        (b.prototype.checkResponsive = function (b, c) {
            ...
            const d = this
            let h = !1
            const i = d.$slider.width()
            const j = window.innerWidth || a(window).width()
            if (
                (d.respondTo === 'window'
                    ? (g = j)
                    : d.respondTo === 'slider'
                    ? (g = i)
                    : d.respondTo === 'min' && (g = Math.min(j, i)),
                d.options.responsive &&
                    d.options.responsive.length &&
                    d.options.responsive !== null)
            ) {
                f = null
                ...
                f !== null
                    ? d.activeBreakpoint !== null
                        ? (f !== d.activeBreakpoint || c) &&
                          ...
                          d.breakpointSettings[f] === 'unslick'
                              ? d.unslick(f)
                              : ((d.options = a.extend(
                                    {},
                                    d.originalSettings,
        ...
        (b.prototype.keyHandler = function (a) {
            ...
            a.target.tagName.match('TEXTAREA|INPUT|SELECT') ||
                (a.keyCode === 37 && b.options.accessibility === !0
                    ? b.changeSlide({
                          data: {
                              message:
        ...
        (b.prototype.progressiveLazyLoad = function (b) {
            ...
            let g
            const c = this
            const d = a('img[data-lazy]', c.$slider)
            d.length
                ? ((e = d.first()),
                  (f = e.attr('data-lazy')),
        ...
        (b.prototype.registerBreakpoints = function () {
            ...
            let e
            const b = this
            const f = b.options.responsive || null
        ...
        (b.prototype.setProps = function () {
            ...
            ;(a.positionProp = a.options.vertical === !0 ? 'top' : 'left'),
                ...
                (void 0 !== b.WebkitTransition ||
                    ...
                    (a.cssTransitions = !0),
                a.options.fade &&
                    (typeof a.options.zIndex === 'number'
        ...
        (b.prototype.selectHandler = function (b) {
            const c = this
            const d = a(b.target).is('.slick-slide')
                ? a(b.target)
                : a(b.target).parents('.slick-slide')
            let e = parseInt(d.attr('data-slick-index'))
            return (
                e || (e = 0),
        ...
        (a.fn.slick = function () {
            ...
            for (f = 0; e > f; f++)
                if (
                    (typeof c === 'object' || typeof c === 'undefined'
